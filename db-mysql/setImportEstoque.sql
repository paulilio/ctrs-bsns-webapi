...
START TRANSACTION;
    ...
    JSON_TABLE(
        ...
        "$[*]" COLUMNS(
            ...
            dsFornecedor VARCHAR(120) PATH '$."dsFornecedor"' NULL ON EMPTY,
            ...
            vlValorTotal VARCHAR(20) PATH '$."vlValorTotal"' NULL ON EMPTY
        )
    ) AS tt;
    ...
    SELECT 
        ...
        ,vlQuantidade 
        ,ExtractDecimal(vlValorTotal) vlValorTotal
        ,dsUnidadeNegocio
        ,dsCentroCusto
    ...
    Veja que tem um campo que informa de onde a tabela produto foi atualizada.
    */
