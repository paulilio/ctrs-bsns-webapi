...
-- tp_estoque: temp
	...
	vlValorUnitario      decimal(20,2)  comment '',
	...
	SELECT JSON_ARRAYAGG(
		...
		'vlValorUnitario', CASE WHEN vlValorUnitario IS NULL THEN 'Não Informado' ELSE REPLACE(REPLACE(REPLACE(FORMAT(vlValorUnitario,2), '.', '|'), ',', '.'), '|', ',') END,
